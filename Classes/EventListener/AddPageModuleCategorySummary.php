 ...
 * of this extension, of `EXT:academic_programs` and of `EXT:academic_partners`. All this listener
 * contributes are the two constants that make it a project summary: the page type and the
 * category group.
 *
